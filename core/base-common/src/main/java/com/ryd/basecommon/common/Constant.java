...
public class Constant {
    ...
    //1、买，2、卖
    public static final Integer STOCK_STQUOTE_TYPE_BUY=1;
    public static final Integer STOCK_STQUOTE_TYPE_SELL=2;
    ...
    //参数配置
    //开盘时间
    public static final String SYSPARAM_OPEN_TIME = "openTime";
    //收盘时间
    public static final String SYSPARAM_CLOSE_TIME = "closeTime";
    //休盘时间开始，结束
    public static final String SYSPARAM_REST_TIME_START = "restTimeStart";
    public static final String SYSPARAM_REST_TIME_END = "restTimeEnd";
    //结算时间
