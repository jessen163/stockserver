...
public class Constant {
    ...
    //1.节假日 2.特殊工作日
    public static Short DATE_SCHEDULE_FESTIVALDAY = 1;
    public static Short DATE_SCHEDULE_SEPCIAL_WORKDAY = 2;

    //参数配置
    //开盘时间
    public static String SYSPARAM_OPEN_TIME = "openTime";
    //收盘时间
    public static String SYSPARAM_CLOSE_TIME = "closeTime";
    //休盘时间开始，结束
    public static String SYSPARAM_REST_TIME_START = "restTimeStart";
    public static String SYSPARAM_REST_TIME_END = "restTimeEnd";
    //结算时间
    public static String SYSPARAM_SETTLE_TIME = "settleTime";
}
